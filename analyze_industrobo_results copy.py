...
def analyze_cascaded_tank_results():
    """
    ...
    # Types to analyzeimport pandas as pd
import numpy as np
import os
import glob
from pathlib import Path
...
def analyze_cascaded_tank_results():
    ...
    for model_dir in model_dirs:
        ...
        for type_val in types:
            ...
            pattern = f"cascaded_tank_h16_z2_n3_mpw{type_val}_No*"
...
if __name__ == "__main__":
    # Run the analysis
    results, file_summary = analyze_cascaded_tank_results()
    ...
    for model_dir in model_dirs:
        ...
        for type_val in types:
            ...
            # Find all files for this type
            pattern = f"cascaded_tank_h64_z12_n3_mpw{type_val}_No*"
            data_files = glob.glob(os.path.join(data_path, pattern))
